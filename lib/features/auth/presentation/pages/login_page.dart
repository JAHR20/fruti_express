...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // 🛡️ ENVOLVEMOS EL BODY EN EL BLOCCONSUMER
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Form(
                      ...
                      children: [
                        const Icon(Icons.hexagon_outlined, size: 40, color: Colors.white),
                        ...
                        CustomAuthField(
                          ...
                          enabled: !isLoading, // Bloqueamos si carga
                        ),
                        const SizedBox(height: 16),
                        CustomAuthField(
                          label: 'Password',
                  ...
                  // --- SECCIÓN BLANCA INFERIOR (Redes Sociales) ---
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        PrimaryAuthButton(
                          ...
                          onPressed: isLoading ? () {} : () => context.go('/register'),
                        ),
                      ],
                    ),
                  ),
