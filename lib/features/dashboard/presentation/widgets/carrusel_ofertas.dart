...
class CarruselOfertas extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Escuchamos el estado del BannerCubit
    return BlocBuilder<BannerCubit, BannerState>(
      builder: (context, state) {
        return state.maybeWhen(
          loaded: (banners) {
            // 🌟 FILTRAMOS: Solo los que tengan activo == true
            final bannersActivos = banners.where((b) => b.activo).toList();
            ...
            return Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  // Usamos tu función de helper para convertir hex a color
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      // Si hay imagen, la ponemos de fondo
                      image: banner.imagenUrl != null 
                        ? DecorationImage(image: NetworkImage(banner.imagenUrl!), fit: BoxFit.cover, opacity: 0.15)
                        : null,
                    ),
                    child: Column(
          ...
          orElse: () => const SizedBox.shrink(), // O un shimmer loading mientras carga
        );
      },
    );
  }

  // Helper local (o muévelo a un util global)
