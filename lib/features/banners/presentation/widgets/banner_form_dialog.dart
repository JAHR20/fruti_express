...
class _BannerFormDialogState extends State<BannerFormDialog> {
  ...
  // 🌟 Manejamos variables de tipo Color nativas para la UI
  ...
  void initState() {
    ...
    // Inicializamos con los colores del banner existente o con un verde pastel por defecto
  ...
  // 🎨 Conversor: De formato Hexadecimal (#E8F5E9) a Color de Flutter
  ...
  // 🎨 Conversor: De Color de Flutter a formato Hexadecimal string para la base de datos
  ...
  // 🌟 Muestra el modal con la paleta visual de colores
      ...
      builder: (context) => AlertDialog(
        ...
        content: SingleChildScrollView(
          child: ColorPicker(
            ...
            enableAlpha: false, // Deshabilitamos opacidad para asegurar un Hex de 6 caracteres válido
  ...
  void _submit() {
    if (_formKey.currentState!.validate()) {
      widget.onGuardar(
        ...
        _colorToHex(_colorInicio), // Convertimos el Color a String Hexadecimal aquí
        _colorToHex(_colorFin),    // Convertimos el Color a String Hexadecimal aquí
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      title: Text(widget.bannerAEditar == null ? 'Nuevo Banner' : 'Editar Banner'),
      content: SingleChildScrollView(
        child: Form(
          key: _formKey,
          child: Column(
            ...
            children: [
                  ...
                  decoration: BoxDecoration(
                    ...
                    image: _imagenSeleccionada != null
                        ...
                        : (widget.bannerAEditar?.imagenUrl != null
                            ? DecorationImage(image: NetworkImage(widget.bannerAEditar!.imagenUrl!), fit: BoxFit.cover)
                            : null),
                  ),
                  child: _imagenSeleccionada == null && widget.bannerAEditar?.imagenUrl == null
                      ? const Column(
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Título (ej. Fin de Semana)', border: OutlineInputBorder()),
                validator: Validators.compose([Validators.required('el título'), Validators.minLength(3, 'El título')]),
              ),
                ...
                children: [
                  Expanded(
                    ...
                    child: TextFormField(
                      ...
                      decoration: const InputDecoration(labelText: 'Descuento (ej. 25% OFF)', border: OutlineInputBorder()),
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(labelText: 'Subtítulo (Términos cortos)', border: OutlineInputBorder()),
                validator: Validators.compose([Validators.required('el subtítulo'), Validators.minLength(4, 'El subtítulo')]),
              ),
              const SizedBox(height: 16),

              // --- 🎨 SECCIÓN DE BOTONES PARA COLORES DE GRADIENTE ---
              const Text('Colores de Fondo', style: TextStyle(fontWeight: FontWeight.bold)),
              const SizedBox(height: 8),
              Row(
                children: [
                  Expanded(
                    child: InkWell(
                      onTap: widget.guardando ? null : () => _mostrarSelectorColor(esColorInicio: true),
                  ...
                  Expanded(
                    child: InkWell(
                      onTap: widget.guardando ? null : () => _mostrarSelectorColor(esColorInicio: false),
                      borderRadius: BorderRadius.circular(8),
                      child: Container(
                        padding: const EdgeInsets.symmetric(vertical: 12, horizontal: 8),
                        decoration: BoxDecoration(
              ...
              // --- 👁️ CAJA DE VISTA PREVIA EN TIEMPO REAL ---
              Container(
                height: 45,
                width: double.infinity,
                decoration: BoxDecoration(
      ...
      actions: [
        ...
        ElevatedButton(
          ...
          child: widget.guardando
              ...
              : Text(widget.bannerAEditar == null ? 'Crear' : 'Actualizar', style: const TextStyle(color: Colors.white)),
        ),
      ],
    );
  }
